...
pub mod keys {
    ...
    // 后台免打扰运行模式相关选项
    pub const OPTION_BACKGROUND_MODE: &str = "background-mode";
    pub const OPTION_BACKGROUND_PASSWORD: &str = "background-password";
    pub const OPTION_BACKGROUND_SILENT_CONNECTION: &str = "background-silent-connection";
